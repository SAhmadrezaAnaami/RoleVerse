...
The current active section is `section/04-admin-operations`. It must pass backend, migration, JavaScript syntax, and browser smoke checks before integration.
